...
import ComponentMixerControls from './controls/ComponentMixerControls.tsx'
import RegionMixerControls from './controls/RegionMixerControls.tsx'
import OutputControls from './controls/OutputControls.tsx'
import { MixerSettings, ImageData } from '../../App'
...
const MixerSidebar: React.FC<MixerSidebarProps> = ({ 
  settings, 
  onSettingsChange, 
  onMix, 
  isProcessing,
